  ...
  return (
    <div>
      ...
      <div className='center'>
        <p><strong>Si te interesa adquirir o saber mas informacion sobre algun producto, dejame tu mensaje <Link to={"/contacto"}><p>aqui</p></Link></strong></p>
      </div>
      <div>
        <div className='grid-inicio'>
          <div className='center' id='collagen'>
            <img className='' src="/collagensinfondo.png" alt="colagen" />
          </div>
        ...
        <div className='grid-inicio'>
          <div className='prueba' id='lumiSpa'>
        ...
        <div className='grid-inicio'>
          <div className='prueba' id='faceSpa'>
        ...
        <div className='grid-inicio'>
          <div className='center' id='wellSpa'>
        ...
        <div className='grid-inicio'>
          ...
          <div className='center' id='omega'>
            <img className='' src="/OMEGASINFO.png" alt="colagen" />
          </div>
        </div>
        <div className='grid-inicio'>
          ...
          <div className='prueba' data-aos="fade-left">
